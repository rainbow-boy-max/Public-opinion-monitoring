...
PASSWORD_TOO_WEAK: {
    ...
    hintZh: '密码需至少8位，包含大小写字母、数字和特殊字符',
    hintEn: 'Password must be at least 8 characters with uppercase, lowercase, digit, and special character',
    actionZh: '重新设置',
    actionEn: 'Retry',
    httpStatus: 400,
  },
  PASSWORD_HISTORY_CONFLICT: {
    code: 'PASSWORD_HISTORY_CONFLICT',
    zh: '密码与历史记录重复',
    en: 'Password matches history',
    hintZh: '新密码不能与最近5次使用的密码相同',
    hintEn: 'New password cannot match any of the last 5 passwords',
    actionZh: '更换新密码',
    actionEn: 'Use different password',
    httpStatus: 400,
  },
  AUTH_MFA_INVALID: {
    ...
    zh: 'MFA 验证码错误',
    en: 'Invalid MFA code',
    hintZh: '请输入正确的 MFA 验证码或使用备用码',
    hintEn: 'Please enter a valid MFA code or use a backup code',
    actionZh: '重新输入',
    actionEn: 'Retry',
    httpStatus: 401,
  },
